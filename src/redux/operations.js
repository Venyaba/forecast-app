...
import {getWeatherRequest, getWeatherSuccess, getWeatherError,getCityWeatherRequest,getCityWeatherSuccess} from './actionTypes'
...
export const getCityWeather = city =>dispatch=>{
    ...
    axios
      .get(url)
      .then(({data})=>{
        dispatch(getCityWeatherSuccess(data))
      })
      .catch(({response})=>{
        console.log(response.data.message)
        dispatch(getWeatherError(response.data.message))
      })
